...
from models.psmt.Model.UnetRs26d.encoder_decoder import *
from models.psmt.Model.UnetRs26d.unet import Unet

encoder_name = 'resnet50d'
...
class EntireModel(BaseModel):
    def __init__(self, num_classes, data_shape=(512,512), sup_loss=torch.nn.CrossEntropyLoss, cons_w_unsup=None):
        ...
        self.encoder1 = Unet(encoder_name=encoder_name, classes=num_classes)
        self.decoder1 = DecoderNetwork(num_classes=num_classes, data_shape=data_shape)
        self.encoder2 = Unet(encoder_name=encoder_name, classes=num_classes)
        self.decoder2 = DecoderNetwork(num_classes=num_classes, data_shape=data_shape)
        self.encoder_s = Unet(encoder_name=encoder_name, classes=num_classes)
