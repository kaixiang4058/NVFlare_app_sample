...
from networks.nets import SimpleCNN
...
from fastai.vision.all import untar_data, DataBlock, aug_transforms, Normalize, URLs, ImageBlock, imagenet_stats, CrossEntropyLossFlat
from fastai.medical.imaging import PILDicom, CategoryBlock
import timm

class FastaiLearner(Learner):  # also supports CIFAR10ScaffoldLearner
    def __init__(
        self,
        dataset_root: str = "/home/u00yjc00/NCKU_image_classification/data2/",
    ...
    def initialize(self, parts: dict, fl_ctx: FLContext):
        ...
        self.train_loader = dls[0]
        self.valid_loader = dls[1]
    ...
    def save_model(self, is_best=False):
        ...
        elif self.aggregation_epochs==0:
            torch.save(save_dict, self.best_local_model_file)
        else:
    ...
    def local_valid(self, valid_loader, abort_signal: Signal, tb_id=None, fl_ctx=None):
        ...
        with torch.no_grad():
            ...
            for i, (inputs, labels) in enumerate(valid_loader):
                ...
                #print((pred_label == labels.data))
                #correct += (pred_label == labels.data).sum().item()
                correct += int(pred_label == labels.data)
